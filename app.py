...
def show_playlist(playlist_id):
    ...
    songs = playlist.songs  # Access songs through the relationship
...
def add_song_to_playlist(playlist_id):
    ...
    curr_on_playlist = playlist.songs.with_entities(Song.id).all()
    available_songs = Song.query.filter(~Song.id.in_(curr_on_playlist)).all()
